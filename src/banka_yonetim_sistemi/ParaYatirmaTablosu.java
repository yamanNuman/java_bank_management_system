...
public class ParaYatirmaTablosu extends javax.swing.JFrame {


    public ParaYatirmaTablosu() {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Transaction_id", "customer_id", "customer_name", "account_number", "deposit_balance", "transaction_mode","transaction_date","transaction_type"
            }
        ));
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        try
        {
            ...
            db.rs=db.stmt.executeQuery("select * from deposit");
            ...
            while(db.rs.next())
            {
                ...
                deposit_balance=db.rs.getString("deposit_balance");
                ...
                Object [] row={transaction_id,customer_id,customer_name,account_number,deposit_balance,transaction_mode,transaction_date,transaction_type};
                model.addRow(row);
            }
        }
        catch(Exception e)
    ...
    public static void main() {
        try {
            ...
            java.util.logging.Logger.getLogger(ParaYatirmaTablosu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParaYatirmaTablosu().setVisible(true);
            }
        });
    }
