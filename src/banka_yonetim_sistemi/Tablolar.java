...
public class Tablolar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Account_Number", "Phone_Number", "Occupation", "Sex", "Nominee","Balance","Address","id","password","type","salary"
            }
        ));
        ...
        jLabel1.setText("Account Tablosu");
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        try
        {
            ...
            while(db.rs.next())
            {
                ...
                adress=db.rs.getString("Address");
                id=db.rs.getString("id");
                password=db.rs.getString("password");
                type=db.rs.getString("type");
                salary=db.rs.getString("salary");
                Object [] row={name,ac,phone,occupation,sex,nominee,balance,adress,id,password,type,salary};
                model.addRow(row);
            }
        }
        catch(Exception e)
